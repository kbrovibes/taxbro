...
- **DCFSA**: If spouse earned income = $0 and no exception, DCFSA exclusion = $0 — add Box 10 back to income.
...
|-------|------|------------|
| `/taxbro-init` | `taxbro-init.md` | Either |
| `/taxbro-extract` | `taxbro-extract.md` | **Gemini** (large context, 30-40 PDFs) |
| `/taxbro-visualize` | `taxbro-visualize.md` | **Claude** (complex HTML generation) |
| `/taxbro-compliance` | `taxbro-compliance.md` | Either (Gemini if web search needed for NAVs) |
| `/taxbro-worksheets` | `taxbro-worksheets.md` | Either |
| `/taxbro-validate-return` | `taxbro-validate-return.md` | **Claude** (nuanced cross-checking) |

Archived skills are in `.agents/commands/archive/` for reference.
